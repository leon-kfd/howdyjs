...
<span class="hljs-keyword">export</span> <span class="hljs-keyword">default</span> defineComponent({
  ...
  <span class="hljs-function"><span class="hljs-title">setup</span>(<span class="hljs-params"></span>)</span> {
    <span class="hljs-keyword">return</span> {
      ...
      <span class="hljs-attr">onScroll</span>: <span class="hljs-function">() =&gt;</span> {
        <span class="hljs-keyword">if</span>(MouseMenuCtx) MouseMenuCtx.close()
      },
      <span class="hljs-attr">options</span>: {
        ...
        <span class="hljs-attr">menuList</span>: [
          {
            ...
            <span class="hljs-attr">fn</span>: <span class="hljs-function">(<span class="hljs-params">params: any, currentEl: HTMLElement, bindingEl: HTMLElement, e: MouseEvent</span>) =&gt;</span> {
        ...
        <span class="hljs-attr">longPressPreventDefault</span>: <span class="hljs-function">(<span class="hljs-params">e: Event, el: HTMLElement</span>) =&gt;</span> {
