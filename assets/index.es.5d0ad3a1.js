import{d as E,b as k,f as H,z as A,A as M,o as $,c as q,i as D,B as j,j as d,C as V,n as S,h as T,D as C,m as z,k as U,T as G,E as w,t as J,q as K,s as Q}from"./index.54bd639f.js";/*! *****************************************************************************
...
***************************************************************************** */function I(n,i,e,o){function t(r){return r instanceof e?r:new e(function(s){s(r)})}return new(e||(e=Promise))(function(r,s){function y(l){try{a(o.next(l))}catch(g){s(g)}}function u(l){try{a(o.throw(l))}catch(g){s(g)}}function a(l){l.done?r(l.value):t(l.value).then(y,u)}a((o=o.apply(n,i||[])).next())})}function X(n,i){const e=i.parentNode;e.lastChild===i?e.appendChild(n):e.insertBefore(n,i.nextSibling)}var h=E({name:"AnimationDialog",props:{width:{type:String,default:"60vw"},height:{type:String,default:"70vh"},animationMode:{type:Boolean,default:!1},animationIn:{type:String,default:"bounceIn"},animationOut:{type:String,default:"bounceOut"},time:{type:Number,default:500},timingFunction:{type:String,default:"ease-in-out"},openFromItself:{type:Boolean,default:!1},appendToBody:{type:Boolean,default:!1},customClass:String,customWrapperClass:String,listenWindowSizeChange:{type:Boolean,default:!1},debounceWait:{type:Number,default:200},title:{type:String},closeOnClickOutside:{type:Boolean,default:!0}},emits:["beforeClose","close"],setup(n,{emit:i}){const e=k(),o=k(),t=k(),r=H(()=>n.time/1e3);let s=null;const y=()=>{s&&clearTimeout(s),s=setTimeout(()=>I(this,void 0,void 0,function*(){const{width:c,height:f}=e.value.getBoundingClientRect();e.value.style.left=`calc(50% - ${c/2}px`,e.value.top=`calc(50% - ${f/2}px)`,yield w();const{top:m,left:p,width:v,height:b}=e.value.getBoundingClientRect();t.value.style.top=`${m}px`,t.value.style.left=`${p}px`,t.value.style.width=`${v}px`,t.value.style.height=`${b}px`}),n.debounceWait)};A(()=>{n.listenWindowSizeChange&&window.addEventListener("resize",y)}),M(()=>{n.listenWindowSizeChange&&window.removeEventListener("resize",y)});const u=k(!1);let a=null,l=null;const g=c=>I(this,void 0,void 0,function*(){if(n.animationMode){u.value=!0,yield w();const{width:f,height:m}=e.value.getBoundingClientRect();e.value.style.left=`calc(50% - ${f/2}px`,e.value.style.top=`calc(50% - ${m/2}px)`,yield w();const{top:p,left:v,width:b,height:x}=e.value.getBoundingClientRect();t.value.style.cssText=`top:${p}px; 
                                    left: ${v}px;
                                    width: ${b}px;
                                    height: ${x}px;
                                    animation: ${n.animationIn} ${r.value}s forwards`}else{u.value=!0,a=c?typeof c=="string"?document.querySelector(c):c:o.value,a.classList.add("is-open"),yield w();const{top:f,left:m,width:p,height:v}=a.getBoundingClientRect();t.value.classList.add("animating"),t.value.style.cssText=`top:${f}px; left: ${m}px;width: ${p}px;height: ${v}px;`;const{width:b,height:x}=e.value.getBoundingClientRect();e.value.style.left=`calc(50% - ${b/2}px`,e.value.style.top=`calc(50% - ${x/2}px)`,n.openFromItself&&(l=a.cloneNode(!0),a.style.visibility="hidden",X(l,a),l.style.cssText="position:absolute;top:0;left:0;right:0;bottom:0;margin:0;width: auto;height:auto;",t.value.querySelector(".dialog-body").appendChild(l)),yield w();const{top:F,left:_,width:N,height:R}=e.value.getBoundingClientRect();t.value.style.cssText=`top:${F}px; 
                                    left: ${_}px;
                                    width: ${N}px;
                                    height: ${R}px;
                                    transition: ${r.value}s all ${n.timingFunction}`,setTimeout(()=>{t.value.classList.remove("animating")},n.time+10)}}),L=()=>{n.closeOnClickOutside&&B()},B=()=>{if(n.animationMode)t.value.style.animation=`${n.animationOut} ${r.value}s forwards`,i("beforeClose"),setTimeout(()=>{u.value=!1,i("close")},n.time-10);else{if(!a)return;const{top:c,left:f,width:m,height:p}=a.getBoundingClientRect();t.value.classList.add("animating"),t.value.style.cssText=`top:${c}px; 
                                    left: ${f}px;
                                    width: ${m}px;
                                    height: ${p}px;
