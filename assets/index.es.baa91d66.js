...
}`;b(y);const l={};class k{constructor({el:r,options:e}){if(r instanceof HTMLElement?this.el=r:this.el=document.querySelector(r),this.imgSrc=(e==null?void 0:e.imgSrc)||this.el.getAttribute("src"),this.el.$imgZoom=this,e!=null&&e.group)if(this.group=e.group,l[this.group]){const n=l[this.group].push({title:e.title,imgSrc:this.imgSrc});this.groupIndex=n-1}else l[this.group]=[{title:e.title,imgSrc:this.imgSrc}],this.groupIndex=0;e!=null&&e.zoomCursor&&(this.el.style.cursor="zoom-in"),this.clickHandler=n=>{e!=null&&e.preventDefault&&n.preventDefault();const t=a("div","__imgZoomMask"),d=a("div","__imgZoomWrapper");document.body.append(t);let s,m;const h=(e==null?void 0:e.showLoading)!==!1;h?(m=e!=null&&e.customLoading?e.customLoading():a("div","__imgZoomLoader"),t.appendChild(m),s=new Image,s.src=this.imgSrc,s.setAttribute("id","__img"),s.onload=()=>{d.contains(s)||(t.appendChild(d),d.appendChild(s)),d.style.display="flex",m.style.display="none"}):(t.appendChild(d),s=new Image,s.src=this.imgSrc,s.setAttribute("id","__img"),d.style.display="flex",d.appendChild(s));const f=()=>{t.style.opacity="0",t.style.transition="all 0.4s",setTimeout(()=>{var i;(i=t==null?void 0:t.parentNode)===null||i===void 0||i.removeChild(t)},400)};if(e!=null&&e.showCloseBtn){const i=a("div","__closeBtn");i.addEventListener("click",f),t.appendChild(i)}else t.addEventListener("click",f),e!=null&&e.zoomCursor&&(t.style.cursor="zoom-out");let g;if(e!=null&&e.title&&(g=a("div","__imgZoomTitle",e.title),t.appendChild(g)),this.group&&l[this.group]){let i=this.groupIndex;const _=a("div","__imgZoomFooter",`${i+1} / ${l[this.group].length}`);t.appendChild(_);const x=a("div","__leftBtn");x.addEventListener("click",u=>{i>0&&(d.style.display="none",s.src=l[this.group][--i].imgSrc,h?s.complete||(m.style.display="block"):setTimeout(()=>{d.style.display="flex"}),_.innerText=`${i+1} / ${l[this.group].length}`,g&&(g.innerText=`${l[this.group][i].title}`)),u.stopPropagation()}),t.appendChild(x);const v=a("div","__rightBtn");v.addEventListener("click",u=>{i<l[this.group].length-1&&(d.style.display="none",s.src=l[this.group][++i].imgSrc,h?s.complete||(m.style.display="block"):setTimeout(()=>{d.style.display="flex"}),_.innerText=`${i+1} / ${l[this.group].length}`,g&&(g.innerText=`${l[this.group][i].title}`)),u.stopPropagation()}),t.appendChild(v)}},this.el.addEventListener("click",this.clickHandler)}destory(){if(this.el.removeEventListener("click",this.clickHandler),this.group&&this.groupIndex&&this.groupIndex>=0){const r=l[this.group].findIndex(e=>e.imgSrc=this.imgSrc);~r&&l[this.group].splice(r,1)}}}const p=(o,r)=>{const{arg:e,value:n}=r;let t={};n?typeof n=="string"?t.imgSrc=n:t=n:t.imgSrc=o.getAttribute("src"),e&&(t.group=e),new k({el:o,options:t})},c=o=>{o.$imgZoom&&o.$imgZoom.destory()},Z={mounted:p,unmounted:c,inserted:p,unbind:c,install(o){o.directive("img-zoom",{mounted:p,unmounted:c,inserted:p,unbind:c})}};export{Z as I};
