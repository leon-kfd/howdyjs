import{e as te,g as p,i as ie,w as j,C as ae,o as c,b as oe,k as b,F as z,q as I,n as L,p as q,l as $,E as O,s as g,m as k,t as T,G as P,T as _e,D,I as ue,J as se}from"./vendor.70dbb883.js";/*! *****************************************************************************
...
***************************************************************************** */function V(e,_,n,i){function s(v){return v instanceof n?v:new n(function(t){t(v)})}return new(n||(n=Promise))(function(v,t){function h(l){try{y(i.next(l))}catch(w){t(w)}}function d(l){try{y(i.throw(l))}catch(w){t(w)}}function y(l){l.done?v(l.value):s(l.value).then(h,d)}y((i=i.apply(e,_||[])).next())})}function de(e,_,n){let i=document.createElement(e);return i.setAttribute("class",_),n&&(i.innerText=n),i}const G=function(e){let _=Array.isArray(e)?[]:{};if(e&&typeof e=="object")for(let n in e)e.hasOwnProperty(n)&&(e[n]&&typeof e[n]=="object"?_[n]=G(e[n]):_[n]=e[n]);return _};var C=te({name:"MouseMenu",props:{appendToBody:{type:Boolean,default:!0},menuWidth:{type:Number,default:200},menuList:{type:Array,required:!0},menuHiddenFn:{type:Function},hasIcon:{type:Boolean,default:!1},iconType:{type:String,default:"font-icon"},menuWrapperCss:Object,menuItemCss:Object,el:{type:Object,required:!0},params:{type:[String,Number,Array,Object]},useLongPressInMobile:Boolean,longPressDuration:Number,injectCloseListener:{type:Boolean,default:!0},customClass:String,disabled:{type:Function}},setup(e){const _=p(0),n=p(0),i=p(!1),s=p(0),v=p(0),t=p(!1),h=p(null),d=p([]),y=ie(()=>e.menuList.some(o=>o.children&&o.children.length>0)),l=p(10),w=p();j(t,o=>V(this,void 0,void 0,function*(){var u,r;if(o){yield D();let m=w.value;e.menuWrapperCss&&Object.keys(e.menuWrapperCss).map(f=>{m.style.setProperty(`--menu-${f}`,e.menuWrapperCss&&e.menuWrapperCss[f])}),e.menuItemCss&&Object.keys(e.menuItemCss).map(f=>{m.style.setProperty(`--menu-item-${f}`,e.menuItemCss&&e.menuItemCss[f])});let a=(r=(u=e.menuItemCss)===null||u===void 0?void 0:u.arrowSize)===null||r===void 0?void 0:r.match(/\d+/);a?l.value=~~a[0]||10:l.value=10,m.style.setProperty("--menu-item-arrowRealSize",l.value/2+"px")}}));const Y=(o,u)=>{o.disabled||(o.fn&&typeof o.fn=="function"&&o.fn(e.params,h.value,e.el,u),t.value=!1)},K=(o,u)=>{o.disabled||(o.fn&&typeof o.fn=="function"&&!o.disabled&&(o.fn(e.params,h.value,e.el,u),i.value=!1),t.value=!1)},Q=(o,u)=>{if(u.children&&!u.disabled){i.value=!0;const r=o.currentTarget;if(!r)return;const{offsetWidth:m}=r,a=r.querySelector(".__menu__sub__wrapper");if(!a)return;const{offsetWidth:f,offsetHeight:x}=a,{innerWidth:ne,innerHeight:R}=window,{top:N,left:B}=r.getBoundingClientRect();B+m+f>ne-5?_.value=B-f+5:_.value=B+m,N+x>R-5?n.value=R-x:n.value=N+5}},A=(o,u,r,m)=>o.map(a=>(a.children&&(a.children=A(a.children,u,r,m)),a.label&&typeof a.label=="function"&&(a.label=a.label(m,u,r)),a.tips&&typeof a.tips=="function"&&(a.tips=a.tips(m,u,r)),a.icon&&typeof a.icon=="function"&&(a.icon=a.icon(m,u,r)),a.hidden&&typeof a.hidden=="function"&&(a.hidden=a.hidden(m,u,r)),a.disabled&&typeof a.disabled=="function"&&(a.disabled=a.disabled(m,u,r)),a)),Z=(o=0,u=0)=>V(this,void 0,void 0,function*(){if(h.value=document.elementFromPoint(o-1,u-1),e.menuHiddenFn?t.value=!e.menuHiddenFn(e.params,h.value,e.el):t.value=!0,!t.value)return;d.value=G(e.menuList),d.value=A(d.value,h.value,e.el,e.params),yield D();const{innerWidth:r,innerHeight:m}=window,f=w.value.offsetHeight,x=e.menuWidth||200;v.value=o+x+1>r?r-x-5:o+1,s.value=u+f+1>m?m-f-5:u+1}),ee=()=>{t.value=!1},W=o=>{w.value&&!w.value.contains(o.currentTarget)&&(t.value=!1,document.oncontextmenu=null)};return j(()=>e.injectCloseListener,o=>{o?document.addEventListener("mousedown",W):document.removeEventListener("mousedown",W)},{immediate:!0}),ae(()=>{document.removeEventListener("mousedown",W)}),{subLeft:_,subTop:n,hoverFlag:i,menuTop:s,menuLeft:v,showMenu:t,clickDomEl:h,calcMenuList:d,arrowSize:l,hasSubMenu:y,MenuWrapper:w,handleMenuItemClick:Y,handleSubMenuItemClick:K,handleMenuMouseEnter:Q,show:Z,close:ee}}});const re=["onMousedown","onMouseenter"],me={key:0,class:"__menu__item-icon"},le={class:"__menu__item-label"},ce={class:"__menu__item-tips"},ve={class:"__menu__item-arrow-after"},be=["onMousedown"],he={class:"__menu__sub__item-label"},fe={class:"__menu__sub__item-tips"};function pe(e,_,n,i,s,v){return c(),oe(_e,{to:"body",disabled:!e.appendToBody},[e.showMenu?(c(),b("div",{key:0,ref:"MenuWrapper",class:L(["__menu__wrapper",e.customClass]),style:P({width:`${e.menuWidth}px`,top:`${e.menuTop}px`,left:`${e.menuLeft}px`})},[(c(!0),b(z,null,I(e.calcMenuList,(t,h)=>(c(),b(z,null,[!t.hidden&&!t.line?(c(),b("div",{key:h,class:L(["__menu__item",t.disabled&&"disabled",t.customClass]),onMousedown:q(d=>e.handleMenuItemClick(t,d),["stop"]),onMouseenter:d=>e.handleMenuMouseEnter(d,t)},[e.hasIcon?(c(),b("span",me,[e.iconType==="font-icon"?$((c(),b("i",{key:0,class:L(t.icon)},null,2)),[[O,t.icon]]):g("v-if",!0)])):g("v-if",!0),k("span",le,T(t.label),1),k("span",ce,T(t.tips||""),1),e.hasSubMenu?(c(),b("span",{key:1,class:L(["__menu__item-arrow",{show:e.hasSubMenu&&t.children}]),style:P({width:e.arrowSize+"px",height:e.arrowSize+"px"})},[$(k("span",ve,null,512),[[O,e.hasSubMenu&&t.children]])],6)):g("v-if",!0),t.children&&t.children.length>0?$((c(),b("div",{key:2,class:"__menu__sub__wrapper",style:P({top:`${e.subTop}px`,left:`${e.subLeft}px`})},[(c(!0),b(z,null,I(t.children,(d,y)=>(c(),b(z,null,[!d.hidden&&!d.line?(c(),b("div",{key:y,class:L(["__menu__sub__item",d.disabled&&"disabled",d.customClass]),onMousedown:q(l=>e.handleSubMenuItemClick(d,l),["stop"])},[k("span",he,T(d.label),1),k("span",fe,T(d.tips||""),1)],42,be)):g("v-if",!0),d.line?(c(),b("div",{key:y,class:"__menu__line"})):g("v-if",!0)],64))),256))],4)),[[O,e.hoverFlag]]):g("v-if",!0)],42,re)):g("v-if",!0),!t.hidden&&t.line?(c(),b("div",{key:h,class:"__menu__line"})):g("v-if",!0)],64))),256))],6)):g("v-if",!0)],8,["disabled"])}function we(e,_){_===void 0&&(_={});var n=_.insertAt;if(!(!e||typeof document=="undefined")){var i=document.head||document.getElementsByTagName("head")[0],s=document.createElement("style");s.type="text/css",n==="top"&&i.firstChild?i.insertBefore(s,i.firstChild):i.appendChild(s),s.styleSheet?s.styleSheet.cssText=e:s.appendChild(document.createTextNode(e))}}var ge=`.__menu__mask[data-v-3d21bc0a] {
  position: fixed;
  top: 0;
  left: 0;
  bottom: 0;
