import{e as ie,g as p,i as ae,w as N,C as oe,o as l,b as D,k as v,F as T,q as I,n as L,p as q,l as z,E,I as _e,s as y,m as k,t as F,G as O,T as ue,D as V,J as se,K as de}from"./vendor.84c53e66.js";/*! *****************************************************************************
...
***************************************************************************** */function G(e,_,n,i){function s(b){return b instanceof n?b:new n(function(t){t(b)})}return new(n||(n=Promise))(function(b,t){function h(c){try{g(i.next(c))}catch(w){t(w)}}function d(c){try{g(i.throw(c))}catch(w){t(w)}}function g(c){c.done?b(c.value):s(c.value).then(h,d)}g((i=i.apply(e,_||[])).next())})}function re(e,_,n){let i=document.createElement(e);return i.setAttribute("class",_),n&&(i.innerText=n),i}const U=function(e){let _=Array.isArray(e)?[]:{};if(e&&typeof e=="object")for(let n in e)e.hasOwnProperty(n)&&(e[n]&&typeof e[n]=="object"?_[n]=U(e[n]):_[n]=e[n]);return _};var M=ie({name:"MouseMenu",props:{appendToBody:{type:Boolean,default:!0},menuWidth:{type:Number,default:200},menuList:{type:Array,required:!0},menuHiddenFn:{type:Function},hasIcon:{type:Boolean,default:!1},iconType:{type:String,default:"font-icon"},menuWrapperCss:Object,menuItemCss:Object,el:{type:Object,required:!0},params:{type:[String,Number,Array,Object]},useLongPressInMobile:Boolean,longPressDuration:Number,injectCloseListener:{type:Boolean,default:!0},customClass:String,disabled:{type:Function}},setup(e){const _=p(0),n=p(0),i=p(!1),s=p(0),b=p(0),t=p(!1),h=p(null),d=p([]),g=ae(()=>e.menuList.some(o=>o.children&&o.children.length>0)),c=p(10),w=p();N(t,o=>G(this,void 0,void 0,function*(){var u,r;if(o){yield V();let m=w.value;e.menuWrapperCss&&Object.keys(e.menuWrapperCss).map(f=>{m.style.setProperty(`--menu-${f}`,e.menuWrapperCss&&e.menuWrapperCss[f])}),e.menuItemCss&&Object.keys(e.menuItemCss).map(f=>{m.style.setProperty(`--menu-item-${f}`,e.menuItemCss&&e.menuItemCss[f])});let a=(r=(u=e.menuItemCss)===null||u===void 0?void 0:u.arrowSize)===null||r===void 0?void 0:r.match(/\d+/);a?c.value=~~a[0]||10:c.value=10,m.style.setProperty("--menu-item-arrowRealSize",c.value/2+"px")}}));const Y=(o,u)=>{o.disabled||(o.fn&&typeof o.fn=="function"&&o.fn(e.params,h.value,e.el,u),t.value=!1)},Q=(o,u)=>{o.disabled||(o.fn&&typeof o.fn=="function"&&!o.disabled&&(o.fn(e.params,h.value,e.el,u),i.value=!1),t.value=!1)},Z=(o,u)=>{if(u.children&&!u.disabled){i.value=!0;const r=o.currentTarget;if(!r)return;const{offsetWidth:m}=r,a=r.querySelector(".__menu__sub__wrapper");if(!a)return;const{offsetWidth:f,offsetHeight:x}=a,{innerWidth:te,innerHeight:R}=window,{top:j,left:H}=r.getBoundingClientRect();H+m+f>te-5?_.value=H-f+5:_.value=H+m,j+x>R-5?n.value=R-x:n.value=j+5}},A=(o,u,r,m)=>o.map(a=>(a.children&&(a.children=A(a.children,u,r,m)),a.label&&typeof a.label=="function"&&(a.label=a.label(m,u,r)),a.tips&&typeof a.tips=="function"&&(a.tips=a.tips(m,u,r)),a.icon&&typeof a.icon=="function"&&(a.icon=a.icon(m,u,r)),a.hidden&&typeof a.hidden=="function"&&(a.hidden=a.hidden(m,u,r)),a.disabled&&typeof a.disabled=="function"&&(a.disabled=a.disabled(m,u,r)),a)),ee=(o=0,u=0)=>G(this,void 0,void 0,function*(){if(h.value=document.elementFromPoint(o-1,u-1),e.menuHiddenFn?t.value=!e.menuHiddenFn(e.params,h.value,e.el):t.value=!0,!t.value)return;d.value=U(e.menuList),d.value=A(d.value,h.value,e.el,e.params),yield V();const{innerWidth:r,innerHeight:m}=window,f=w.value.offsetHeight,x=e.menuWidth||200;b.value=o+x+1>r?r-x-5:o+1,s.value=u+f+1>m?m-f-5:u+1}),ne=()=>{t.value=!1},$=o=>{w.value&&!w.value.contains(o.currentTarget)&&(t.value=!1,document.oncontextmenu=null)};return N(()=>e.injectCloseListener,o=>{o?document.addEventListener("mousedown",$):document.removeEventListener("mousedown",$)},{immediate:!0}),oe(()=>{document.removeEventListener("mousedown",$)}),{subLeft:_,subTop:n,hoverFlag:i,menuTop:s,menuLeft:b,showMenu:t,clickDomEl:h,calcMenuList:d,arrowSize:c,hasSubMenu:g,MenuWrapper:w,handleMenuItemClick:Y,handleSubMenuItemClick:Q,handleMenuMouseEnter:Z,show:ee,close:ne}}});const me=["onMousedown","onMouseenter"],le={key:0,class:"__menu__item-icon"},ce=["innerHTML"],ve={class:"__menu__item-label"},be={class:"__menu__item-tips"},he={class:"__menu__item-arrow-after"},fe=["onMousedown"],pe={class:"__menu__sub__item-label"},we={class:"__menu__sub__item-tips"};function ye(e,_,n,i,s,b){return l(),D(ue,{to:"body",disabled:!e.appendToBody},[e.showMenu?(l(),v("div",{key:0,ref:"MenuWrapper",class:L(["__menu__wrapper",e.customClass]),style:O({width:`${e.menuWidth}px`,top:`${e.menuTop}px`,left:`${e.menuLeft}px`})},[(l(!0),v(T,null,I(e.calcMenuList,(t,h)=>(l(),v(T,null,[!t.hidden&&!t.line?(l(),v("div",{key:h,class:L(["__menu__item",t.disabled&&"disabled",t.customClass]),onMousedown:q(d=>e.handleMenuItemClick(t,d),["stop"]),onMouseenter:d=>e.handleMenuMouseEnter(d,t)},[e.hasIcon?(l(),v("div",le,[e.iconType==="font-icon"?z((l(),v("i",{key:0,class:L(t.icon)},null,2)),[[E,t.icon]]):e.iconType==="svg-icon"?z((l(),v("div",{key:1,class:"__menu__item-icon-svg",innerHTML:t.icon},null,8,ce)),[[E,t.icon]]):e.iconType==="vnode-icon"?(l(),D(_e(t.icon),{key:2})):y("v-if",!0)])):y("v-if",!0),k("span",ve,F(t.label),1),k("span",be,F(t.tips||""),1),e.hasSubMenu?(l(),v("span",{key:1,class:L(["__menu__item-arrow",{show:e.hasSubMenu&&t.children}]),style:O({width:e.arrowSize+"px",height:e.arrowSize+"px"})},[z(k("span",he,null,512),[[E,e.hasSubMenu&&t.children]])],6)):y("v-if",!0),t.children&&t.children.length>0?z((l(),v("div",{key:2,class:"__menu__sub__wrapper",style:O({top:`${e.subTop}px`,left:`${e.subLeft}px`})},[(l(!0),v(T,null,I(t.children,(d,g)=>(l(),v(T,null,[!d.hidden&&!d.line?(l(),v("div",{key:g,class:L(["__menu__sub__item",d.disabled&&"disabled",d.customClass]),onMousedown:q(c=>e.handleSubMenuItemClick(d,c),["stop"])},[k("span",pe,F(d.label),1),k("span",we,F(d.tips||""),1)],42,fe)):y("v-if",!0),d.line?(l(),v("div",{key:g,class:"__menu__line"})):y("v-if",!0)],64))),256))],4)),[[E,e.hoverFlag]]):y("v-if",!0)],42,me)):y("v-if",!0),!t.hidden&&t.line?(l(),v("div",{key:h,class:"__menu__line"})):y("v-if",!0)],64))),256))],6)):y("v-if",!0)],8,["disabled"])}function ge(e,_){_===void 0&&(_={});var n=_.insertAt;if(!(!e||typeof document=="undefined")){var i=document.head||document.getElementsByTagName("head")[0],s=document.createElement("style");s.type="text/css",n==="top"&&i.firstChild?i.insertBefore(s,i.firstChild):i.appendChild(s),s.styleSheet?s.styleSheet.cssText=e:s.appendChild(document.createTextNode(e))}}var Ce=`.__menu__mask[data-v-3d21bc0a] {
  position: fixed;
  top: 0;
  left: 0;
  bottom: 0;
...
.__menu__item:hover .__menu__sub__wrapper[data-v-3d21bc0a] {
  visibility: visible;
}`;ge(Ce);M.render=ye;M.__scopeId="data-v-3d21bc0a";M.__file="packages/mouse-menu/mouse-menu.vue";M.install=e=>{e.component(M.name,M)};function J(e){var _;const n="__mouse__menu__container";let i;document.querySelector(`.${n}`)?i=document.querySelector(`.${n}`):i=re("div",n);const s=se(M,e);return de(s,i),document.body.appendChild(i),(_=s.component)===null||_===void 0?void 0:_.proxy}let S,W,P,C;function Me(e,_,n=500){P=i=>{S&&S.close(),i.preventDefault(),W&&clearTimeout(W),W=window.setTimeout(()=>{_(i)},n)},C=()=>{clearTimeout(W)},e.addEventListener("touchstart",P),e.addEventListener("touchmove",C),e.addEventListener("touchend",C),e.addEventListener("touchcancel",C)}function X(e){e.removeEventListener("touchstart",P),e.removeEventListener("touchmove",C),e.removeEventListener("touchend",C),e.removeEventListener("touchcancel",C)}let B,K;const Se=(e,_)=>{const{value:n}=_;if(n.menuList.length>0)B=i=>{if(typeof n.disabled=="function"&&n.disabled(n.params))return;i.preventDefault();const s=J(Object.assign({el:e},n)),{x:b,y:t}=i;s.show(b,t)},e.removeEventListener("contextmenu",B),e.addEventListener("contextmenu",B),n.useLongPressInMobile&&"ontouchstart"in window&&(K=i=>{if(typeof n.disabled=="function"&&n.disabled(n.params))return;i.preventDefault(),S=J(Object.assign({el:e},n));const{touches:s}=i,{clientX:b,clientY:t}=s[0];S.show(b,t),document.onmousedown=null,e.onmousedown=null,setTimeout(()=>{document.onmousedown=()=>S.close(),e.onmousedown=()=>S.close()},500)},X(e),Me(e,K,n.longPressDuration||500));else throw new Error("At least set one menu list!")},xe=e=>{e.removeEventListener("contextmenu",B),"touchstart"in window&&X(e)},ke={mounted:Se,unmounted:xe};export{ke as M};
