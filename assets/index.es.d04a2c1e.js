import{d as ie,a as p,e as ae,w as N,A as oe,o as l,c as I,g as v,F as T,k as D,n as L,j as q,h as z,B as E,G as _e,l as y,i as k,t as F,C as O,T as ue,E as V,H as se,I as de}from"./index.f096232d.js";/*! *****************************************************************************
...
.__menu__item:hover .__menu__sub__wrapper[data-v-3d21bc0a] {
  visibility: visible;
}`;ge(Ce);M.render=ye;M.__scopeId="data-v-3d21bc0a";M.__file="packages/mouse-menu/mouse-menu.vue";M.install=e=>{e.component(M.name,M)};function U(e){var _;const n="__mouse__menu__container";let i;document.querySelector(`.${n}`)?i=document.querySelector(`.${n}`):i=re("div",n);const s=se(M,e);return de(s,i),document.body.appendChild(i),(_=s.component)===null||_===void 0?void 0:_.proxy}let S,W,P,C;function Me(e,_,n=500){P=i=>{S&&S.close(),i.preventDefault(),W&&clearTimeout(W),W=window.setTimeout(()=>{_(i)},n)},C=()=>{clearTimeout(W)},e.addEventListener("touchstart",P),e.addEventListener("touchmove",C),e.addEventListener("touchend",C),e.addEventListener("touchcancel",C)}function J(e){e.removeEventListener("touchstart",P),e.removeEventListener("touchmove",C),e.removeEventListener("touchend",C),e.removeEventListener("touchcancel",C)}let B,X;const Se=(e,_)=>{const{value:n}=_;if(n.menuList.length>0)B=i=>{if(typeof n.disabled=="function"&&n.disabled(n.params))return;i.preventDefault();const s=U(Object.assign({el:e},n)),{x:b,y:t}=i;s.show(b,t)},e.removeEventListener("contextmenu",B),e.addEventListener("contextmenu",B),n.useLongPressInMobile&&"ontouchstart"in window&&(X=i=>{if(typeof n.disabled=="function"&&n.disabled(n.params))return;i.preventDefault(),S=U(Object.assign({el:e},n));const{touches:s}=i,{clientX:b,clientY:t}=s[0];S.show(b,t),document.onmousedown=null,e.onmousedown=null,setTimeout(()=>{document.onmousedown=()=>S.close(),e.onmousedown=()=>S.close()},500)},J(e),Me(e,X,n.longPressDuration||500));else throw new Error("At least set one menu list!")},xe=e=>{e.removeEventListener("contextmenu",B),"touchstart"in window&&J(e)},ke={mounted:Se,unmounted:xe};export{ke as M};
