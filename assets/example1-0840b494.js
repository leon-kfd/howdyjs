...
<span class="hljs-keyword">const</span> options: CustomMouseMenuOptions = {
  ...
  <span class="hljs-attr">onOpen</span>: <span class="hljs-function">(<span class="hljs-params">params, currentEl, bindingEl</span>) =&gt;</span> {
    <span class="hljs-built_in">console</span>.log(<span class="hljs-string">&#x27;onOpen&#x27;</span>, params, currentEl, bindingEl)
  },
  <span class="hljs-comment">// 菜单Close回调</span>
  <span class="hljs-attr">onClose</span>: <span class="hljs-function">(<span class="hljs-params">params, currentEl, bindingEl</span>) =&gt;</span> {
    <span class="hljs-built_in">console</span>.log(<span class="hljs-string">&#x27;onClose&#x27;</span>, params, currentEl, bindingEl)
  },
