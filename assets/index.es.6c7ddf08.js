...
.__menu__item:hover .__menu__sub__wrapper[data-v-3d21bc0a] {
  visibility: visible;
}`;we(ge);C.render=pe;C.__scopeId="data-v-3d21bc0a";C.__file="packages/mouse-menu/mouse-menu.vue";C.install=e=>{e.component(C.name,C)};function J(e){var _;const n="__mouse__menu__container";let i;document.querySelector(`.${n}`)?i=document.querySelector(`.${n}`):i=re("div",n);const u=ue(C,e);return se(u,i),document.body.appendChild(i),(_=u.component)===null||_===void 0?void 0:_.proxy}let S,E,H,M;function ye(e,_,n=500){H=i=>{S&&S.close(),i.preventDefault(),E&&clearTimeout(E),E=window.setTimeout(()=>{_(i)},n)},M=()=>{clearTimeout(E)},e.addEventListener("touchstart",H),e.addEventListener("touchmove",M),e.addEventListener("touchend",M),e.addEventListener("touchcancel",M)}function U(e){e.removeEventListener("touchstart",H),e.removeEventListener("touchmove",M),e.removeEventListener("touchend",M),e.removeEventListener("touchcancel",M)}let F,X;const Ce=(e,_)=>{const{value:n}=_;if(n.menuList.length>0)F=i=>{i.preventDefault();const u=J(Object.assign({el:e},n)),{x:c,y:t}=i;u.show(c,t)},e.removeEventListener("contextmenu",F),e.addEventListener("contextmenu",F),n.useLongPressInMobile&&"ontouchstart"in window&&(X=i=>{if(typeof n.disabled=="function"&&n.disabled(n.params))return;i.preventDefault(),S=J(Object.assign({el:e},n));const{touches:u}=i,{clientX:c,clientY:t}=u[0];S.show(c,t),document.onmousedown=null,e.onmousedown=null,setTimeout(()=>{document.onmousedown=()=>S.close(),e.onmousedown=()=>S.close()},500)},U(e),ye(e,X,n.longPressDuration||500));else throw new Error("At least set one menu list!")},Me=e=>{e.removeEventListener("contextmenu",F),"touchstart"in window&&U(e)},xe={mounted:Ce,unmounted:Me};export{xe as M};
