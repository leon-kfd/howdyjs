import{e as H,g as k,i as E,B as M,C as A,D as w,o as $,b as D,l as j,E as q,m as d,G as V,n as S,k as T,H as C,s as z,p as G,T as U,t as J,y as K,z as Q}from"./vendor.d601da5d.js";/*! *****************************************************************************
...
***************************************************************************** */function I(n,i,e,o){function t(r){return r instanceof e?r:new e(function(s){s(r)})}return new(e||(e=Promise))(function(r,s){function y(l){try{a(o.next(l))}catch(h){s(h)}}function u(l){try{a(o.throw(l))}catch(h){s(h)}}function a(l){l.done?r(l.value):t(l.value).then(y,u)}a((o=o.apply(n,i||[])).next())})}function X(n,i){const e=i.parentNode;e.lastChild===i?e.appendChild(n):e.insertBefore(n,i.nextSibling)}var g=H({name:"AnimationDialog",props:{width:{type:String,default:"60vw"},height:{type:String,default:"70vh"},animationMode:{type:Boolean,default:!1},animationIn:{type:String,default:"bounceIn"},animationOut:{type:String,default:"bounceOut"},time:{type:Number,default:500},timingFunction:{type:String,default:"ease-in-out"},openFromItself:{type:Boolean,default:!1},appendToBody:{type:Boolean,default:!1},customClass:String,customWrapperClass:String,listenWindowSizeChange:{type:Boolean,default:!1},debounceWait:{type:Number,default:200},title:{type:String},closeOnClickOutside:{type:Boolean,default:!0}},emits:["beforeClose","close"],setup(n,{emit:i}){const e=k(),o=k(),t=k(),r=E(()=>n.time/1e3);let s=null;const y=()=>{s&&clearTimeout(s),s=setTimeout(()=>I(this,void 0,void 0,function*(){const{width:c,height:f}=e.value.getBoundingClientRect();e.value.style.left=`calc(50% - ${c/2}px`,e.value.top=`calc(50% - ${f/2}px)`,yield w();const{top:p,left:m,width:v,height:b}=e.value.getBoundingClientRect();t.value.style.top=`${p}px`,t.value.style.left=`${m}px`,t.value.style.width=`${v}px`,t.value.style.height=`${b}px`}),n.debounceWait)};M(()=>{n.listenWindowSizeChange&&window.addEventListener("resize",y)}),A(()=>{n.listenWindowSizeChange&&window.removeEventListener("resize",y)});const u=k(!1);let a=null,l=null;const h=c=>I(this,void 0,void 0,function*(){if(n.animationMode){u.value=!0,yield w();const{width:f,height:p}=e.value.getBoundingClientRect();e.value.style.left=`calc(50% - ${f/2}px`,e.value.style.top=`calc(50% - ${p/2}px)`,yield w();const{top:m,left:v,width:b,height:x}=e.value.getBoundingClientRect();t.value.style.cssText=`top:${m}px; 
                                    left: ${v}px;
                                    width: ${b}px;
                                    height: ${x}px;
                                    animation: ${n.animationIn} ${r.value}s forwards`}else{u.value=!0,a=c?typeof c=="string"?document.querySelector(c):c:o.value,a.classList.add("is-open"),yield w();const{top:f,left:p,width:m,height:v}=a.getBoundingClientRect();t.value.classList.add("animating"),t.value.style.cssText=`top:${f}px; left: ${p}px;width: ${m}px;height: ${v}px;`;const{width:b,height:x}=e.value.getBoundingClientRect();e.value.style.left=`calc(50% - ${b/2}px`,e.value.style.top=`calc(50% - ${x/2}px)`,n.openFromItself&&(l=a.cloneNode(!0),a.style.visibility="hidden",X(l,a),l.style.cssText="position:absolute;top:0;left:0;right:0;bottom:0;margin:0;width: auto;height:auto;",t.value.querySelector(".dialog-body").appendChild(l)),yield w();const{top:F,left:_,width:N,height:R}=e.value.getBoundingClientRect();t.value.style.cssText=`top:${F}px; 
                                    left: ${_}px;
                                    width: ${N}px;
                                    height: ${R}px;
...
`;W(rn);g.render=ln;g.__scopeId="data-v-1424118a";g.__file="packages/animation-dialog/animation-dialog.vue";g.install=n=>{n.component(g.name,g)};export{g as s};
