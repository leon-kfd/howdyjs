...
<span class="hljs-keyword">const</span> list = ref&lt;Record&lt;string, any&gt;[]&gt;([])
...
<span class="hljs-keyword">const</span> options: CustomMouseMenuOptions = {
  ...
  <span class="hljs-attr">menuList</span>: [
    {
      <span class="hljs-attr">label</span>: <span class="hljs-function">(<span class="hljs-params">params</span>) =&gt;</span> <span class="hljs-string">\`#<span class="hljs-subst">\${params.userName}</span>\`</span>,
