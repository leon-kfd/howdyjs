function a(i,n,e){const r=document.createElement(i);return r.setAttribute("id",n),e&&(r.innerText=e),r}function v(i,n){n===void 0&&(n={});var e=n.insertAt;if(!(!i||typeof document>"u")){var r=document.head||document.getElementsByTagName("head")[0],t=document.createElement("style");t.type="text/css",e==="top"&&r.firstChild?r.insertBefore(t,r.firstChild):r.appendChild(t),t.styleSheet?t.styleSheet.cssText=i:t.appendChild(document.createTextNode(i))}}var Z=`#__imgZoomMask {
  position: fixed;
  top: 0;
  left: 0;
  width: 100vw;
