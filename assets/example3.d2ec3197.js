...
<span class="hljs-keyword">import</span> { defineComponent, onMounted, onUnmounted } <span class="hljs-keyword">from</span> <span class="hljs-string">&#x27;vue&#x27;</span>;
...
<span class="hljs-keyword">export</span> <span class="hljs-keyword">default</span> defineComponent({
  ...
  <span class="hljs-function"><span class="hljs-title">setup</span>(<span class="hljs-params"></span>)</span> {
    onMounted(<span class="hljs-function">() =&gt;</span> {
      <span class="hljs-keyword">const</span> cssLink = <span class="hljs-built_in">document</span>.createElement(<span class="hljs-string">&#x27;link&#x27;</span>);
      cssLink.id = <span class="hljs-string">&#x27;fontawesomeCDN&#x27;</span>;
      cssLink.rel  = <span class="hljs-string">&#x27;stylesheet&#x27;</span>;
      cssLink.type = <span class="hljs-string">&#x27;text/css&#x27;</span>;
      cssLink.href = <span class="hljs-string">&#x27;https://cdn.bootcdn.net/ajax/libs/font-awesome/5.15.3/css/all.min.css&#x27;</span>;
      <span class="hljs-built_in">document</span>.querySelector(<span class="hljs-string">&#x27;head&#x27;</span>)?.appendChild(cssLink);
    });
    onUnmounted(<span class="hljs-function">() =&gt;</span> {
      <span class="hljs-keyword">const</span> cssLink = <span class="hljs-built_in">document</span>.querySelector(<span class="hljs-string">&#x27;#fontawesomeCDN&#x27;</span>);
