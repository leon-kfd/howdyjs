...
<span class="hljs-keyword">const</span> options: CustomMouseMenuOptions = {
  ...
  <span class="hljs-attr">menuHiddenFn</span>: <span class="hljs-function">(<span class="hljs-params">params, el</span>) =&gt;</span> !el?.getAttribute(<span class="hljs-string">&#x27;class&#x27;</span>)?.includes(<span class="hljs-string">&#x27;box-listitem&#x27;</span>),
  <span class="hljs-attr">menuList</span>: [
    {
      <span class="hljs-attr">label</span>: <span class="hljs-function">(<span class="hljs-params">params, currentEl</span>) =&gt;</span> {
    ...
    },
    {
      ...
      <span class="hljs-attr">hidden</span>: <span class="hljs-function">(<span class="hljs-params">params, currentEl</span>) =&gt;</span> [<span class="hljs-string">&#x27;1&#x27;</span>, <span class="hljs-string">&#x27;5&#x27;</span>, <span class="hljs-string">&#x27;9&#x27;</span>].includes(currentEl?.getAttribute(<span class="hljs-string">&#x27;data-id&#x27;</span>) <span class="hljs-keyword">as</span> string)
    },
    {
      ...
      <span class="hljs-attr">disabled</span>: <span class="hljs-function">(<span class="hljs-params">params, currentEl</span>) =&gt;</span> [<span class="hljs-string">&#x27;2&#x27;</span>, <span class="hljs-string">&#x27;4&#x27;</span>, <span class="hljs-string">&#x27;6&#x27;</span>].includes(currentEl?.getAttribute(<span class="hljs-string">&#x27;data-id&#x27;</span>) <span class="hljs-keyword">as</span> string)
    },
    {
